...
<script type="application/json">
{
  ...
  "description": "A Raspberry-pi HAT + python controller to streamline the deployment of interactive physical installations like the ones found on participative museums. ",
  "tags": [
    "py-module",
    "Electronics",
    "Open-source",
