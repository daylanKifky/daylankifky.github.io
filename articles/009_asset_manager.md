# Asset manager for distributed pipelines
...
It's all implemented in Python with minimal dependencies. It offers a CLI interface for common tasks, as well as a Python API for automation and custom workflows.
